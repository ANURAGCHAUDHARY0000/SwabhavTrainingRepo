<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="SchemaApproach.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div style ="font-family:Arial">
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetDepartments" TypeName="SchemaApproach.EmployeeRepository"></asp:ObjectDataSource>
