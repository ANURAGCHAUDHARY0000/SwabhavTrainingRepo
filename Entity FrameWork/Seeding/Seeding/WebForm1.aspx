<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Seeding.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div style ="font-family : Arial">
            ...
            <br />
            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="ID" DataSourceID="EntityDataSource1" DefaultMode="Insert" ForeColor="#333333" GridLines="None" Height="50px" OnPageIndexChanging="DetailsView1_PageIndexChanging" Width="125px" OnItemInserted="allviews">
                <AlternatingRowStyle BackColor="White" />
